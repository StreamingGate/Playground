...
(
    ...
    dislike_cnt     integer  not null,
    host_email      varchar(30),
    like_cnt        integer  not null,
    live_room_state varchar(10),
...
alter table live_viewer
    add constraint FKl4jneonk8e7lghuvykdkck79l foreign key (users_id) references users (id);
alter table video
