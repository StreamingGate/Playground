...
alter table live
    add constraint FK92l0bpkdmody39uwicxkcvul2 foreign key (users_id) references users (id);
alter table live_viewer
    add constraint FK4wmoyubomxmidp6hqd21ujiud foreign key (live_room_id) references live (id);
alter table live_viewer
