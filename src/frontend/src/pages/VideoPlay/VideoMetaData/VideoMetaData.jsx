    ...
    <S.VideoMetaDataContainer>
      ...
      <S.VideoSubInfoContainer>
        ...
        <S.VideoSubInfo>
          ...
          <S.ContentOverview>
            때는 1920년대, 당시 유럽은 그린델왈드의 득세로 혼란스러운 시기였다. 영화가 시작하자마자
            한밤중에 오러 5명이 루모스 마법을 사용해 어느 한 대저택에 조심조심 접근하는데 갑자기
            대문이 열리더니 초록색 불빛과 함께 오러 5명은 순식간에 충격파로 죽게 된다. 이후 그들의
            시체 앞에 그린델왈드의 뒷모습이 나타나며 영화 시작. 그 후에는 그린델왈드 관련 소식과 각
            나라마다의 대처 등의 이슈를 담은 신문기사들이 해리 포터 5편처럼 빠르게 지나간다. 그런데
            어느 순간 그린델왈드가 유럽에서 자취를 감추게 된다.
          </S.ContentOverview>
        </S.VideoSubInfo>
